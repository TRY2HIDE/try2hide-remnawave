...
- `REFERRAL_REGISTRATION_NEW_USER_BONUS_KOPEKS=0` - бонус приглашённому при регистрации выключен
- `REFERRAL_REGISTRATION_NEW_USER_BONUS_KOPEKS=50000` - приглашённый получает 500₽ сразу после регистрации
...
- Если `REFERRAL_REGISTRATION_NEW_USER_BONUS_KOPEKS > 0`, приглашённый тоже получает фиксированный бонус сразу после регистрации
